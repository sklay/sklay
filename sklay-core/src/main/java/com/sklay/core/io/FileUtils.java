...
public class FileUtils {
	...
	public static String readFileToString(String relativePath,
			ServletContext context) throws IOException {
		InputStream is = context.getResourceAsStream(relativePath);
		return IOUtils.toString(is);
	}

	public static void writeStringToFile(String string, String relativePath,
			ServletContext context) throws IOException {
	...
	public static File getFile(String relativePath, ServletContext context)
