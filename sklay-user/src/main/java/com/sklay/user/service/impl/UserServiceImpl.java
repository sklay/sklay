/**
 * Project name : sklay-user
 * File name : UserServiceImpl.java
 * Package name : com.sklay.user.service.impl
 * Date : 2013-11-27
 * Copyright : 2013 , sklay.COM All Rights Reserved
 * Author : stormning@163.com
 */
package com.sklay.user.service.impl;
...
import com.sklay.user.dao.UserDao;
import com.sklay.user.dao.UserExtDao;
import com.sklay.user.dao.UserGroupDao;
import com.sklay.user.model.User;
import com.sklay.user.model.UserGroup;
import com.sklay.user.model.UserGroupPK;
import com.sklay.user.service.UserService;
import com.sklay.user.util.Status;
...
public class UserServiceImpl implements UserService {
	...
	/* (non-Javadoc)
	 * @see com.sklay.user.service.UserService#countRealUser()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.sklay.user.service.UserService#randomFakeUser()
	 */
	@Override
	...
	public User generateFakeUser(String password) {
		...
		user.setNickName(com.sklay.core.util.StringUtils.randomName()+com.sklay.core.util.StringUtils.randomName());
		regist(user);
		return user;
	}

	/* (non-Javadoc)
	 * @see com.sklay.user.service.UserService#getFakeUser()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.sklay.user.service.UserService#getUsersByIds(java.util.Set)
	 */
	@Override
