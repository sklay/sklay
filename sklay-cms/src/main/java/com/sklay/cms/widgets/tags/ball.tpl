<script type="text/javascript" src="${resource}/ball.js" ></script>
<link rel="stylesheet" href="${resource}/ball.css" type="text/css">
<div id="tagsList" width="${widget.settings.width!!}" height="${widget.settings.height!!}">
