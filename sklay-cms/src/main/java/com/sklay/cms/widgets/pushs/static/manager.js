$(function() {
	...
	var typeHelper = $("<div id='typeHelper'><button class='btn btn-small btn-del'>删除</button><button class='btn btn-small'>添加</button></div>").appendTo("body");
	...
	$('#typeHelper .btn-del').on('click',function(){
